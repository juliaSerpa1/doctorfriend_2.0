...
import 'package:doctorfriend/components/google_places_auto_complete_text_form_field/model/place_details.dart';
import 'package:doctorfriend/components/google_places_auto_complete_text_form_field/model/prediction.dart';
...
class _GooglePlacesAutoCompleteTextFormFieldState
  ...
  Future<void> getLocation(String text, [String language = "pt"]) async {
    ...
    final subscriptionResponse = PlacesAutocompleteResponse.fromJson(data);
